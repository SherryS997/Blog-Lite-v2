            ...
            <div class="col-md-12 col-lg-10 col-xl-10 col-xxl-10">
              <div class="card mb-5">
                <div class="card-body p-sm-5" style="padding-right: 11px">
                  <div class="mb-3">
                    <h2 class="text-centre mb-4">Upload Article</h2>
                  </div>
                  <p class="fs-6 card-text">Upload an image below:</p>
                  <div
                    class="text-center"
  ...
  methods: {
    ...
    async upload() {
      if (this.userSession && this.isValid) {
        ...
        await axios
          .post("http://192.168.1.8:2345/vueapp/post", formData, {
            headers: {
